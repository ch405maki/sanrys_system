    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex justify-between items-center p-[4px]">
                ...
                <div>
                    <!-- Status Filter -->
                    <select v-model="selectedFilterStatus" class="border border-gray-300 rounded-md p-2 w-32 mr-2">
                    ...
                    <a :href="route('employee.create')" class="bg-green-600 hover:bg-green-700 py-[11px] px-4 rounded-md text-white"> <i class="fa-solid fa-user-plus mr-2"></i> Add New</a>
                </div>
            </div>
        </template>
                                        ...
                                        <tr v-for="employee in filteredEmployees" :key="employee.id" class="bg-white transition-all duration-500 hover:bg-gray-50">
                                            ...
                                            <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                                <div class="py-1.5 px-2.5 rounded-full flex justify-center items-center gap-1">
                                                    <span class="font-medium text-xs text-emerald-600 uppercase"><i class="fa-solid fa-chart-simple mr-2"></i>{{ employee?.status }}</span>
                                                </div>
                                            </td>
