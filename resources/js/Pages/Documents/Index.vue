                                ...
                                <tbody class="divide-y divide-gray-300 ">
                                    <tr v-for="user in users" class="bg-white transition-all duration-500 hover:bg-gray-50">
                                        ...
                                        <td class="flex p-5 items-center justify-center gap-0.5">
                                            <a :href="route('documents.show', user.id)" class="bg-green-100 text-sm hover:bg-green-200 py-3 px-4 rounded-md border border-green-500 text-gray-700"> <i class="fa-solid fa-folder"></i> View Documents</a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
