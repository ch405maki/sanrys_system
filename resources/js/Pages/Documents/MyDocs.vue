    ...
    <AuthenticatedLayout>
                            ...
                            <table class="table-auto min-w-full rounded-xl">
                                <thead>
                                    <tr class="bg-gray-50">
                                        ...
                                        <th scope="col" class="p-5 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize min-w-[150px]"> File Type </th>
                                ...
                                <tbody class="divide-y divide-gray-300 ">
                                    <tr v-for="index of 4" class="bg-white transition-all duration-500 hover:bg-gray-50">
                                        <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> File Name </td>
                                        <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> PDF </td>
                                        <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> This is a certification </td>
        ...
        <div v-if="isUploadModalOpen" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div class="bg-white rounded-lg shadow-lg px-6 py-8 w-full max-w-md relative">
                ...
                <form>
                    <!-- Form fields for uploading a document -->
                    ...
                    <button type="submit" class="bg-green-600 hover:bg-green-700 text-white py-2 px-4 rounded-md mt-4 float-right">Upload</button>
                </form>
            </div>
        </div>
    </AuthenticatedLayout>
